...
CGRect CGRectMakeForFit(CGRect rect)
{
    ...
    newRect.origin.x = CGRectGetMinX(rect)*YZScaleX;   //等比例x
    newRect.origin.y = CGRectGetMinY(rect)*YZScaleY;   //等比例y
    newRect.size.width = CGRectGetWidth(rect)*YZScaleX;//等比例宽
    newRect.size.height = CGRectGetHeight(rect)*YZScaleY;//等比例高
